...
if uploaded_file is not None:
    ...
    classification_image_path = "assets/classification_report.png"
    model_image = Image.open(model_image_path)
    roc_image = Image.open(roc_image_path)
    classification_image = Image.open(classification_image_path)
    st.image(model_image, caption="Model Diagram", use_container_width=True)
    st.image(classification_image, caption="Classification Report (XGBoost)", use_container_width=True)
